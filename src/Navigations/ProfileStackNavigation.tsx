...
const ProfileStackNavigation: React.FC = () => {
  return (
    <ProfileStack.Navigator initialRouteName="ProfileScreen" screenOptions={{ headerShown: false }}>
      ...
      <ProfileStack.Screen name="ProfileUpdateScreen" component={ProfileUpdateScreen}></ProfileStack.Screen>
      <ProfileStack.Screen name="RegisterScreen" component={RegisterScreen}></ProfileStack.Screen>
